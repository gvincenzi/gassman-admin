...
public class MainView extends VerticalLayout {
    ...
    public MainView(ButtonLabelConfig buttonLabelConfig) {
        ...
        Button buttonDiscoveryProduct = new Button(
                buttonLabelConfig.getDiscoveryProductManagement(), VaadinIcon.BULLSEYE.create());
        buttonDiscoveryProduct.addClickListener(e ->
                buttonDiscoveryProduct.getUI().ifPresent(ui ->
                        ui.navigate("discoveryproducts"))
        );
        ...
        // build layout
        HorizontalLayout actions = new HorizontalLayout(buttonUser, buttonProduct, buttonDiscoveryProduct, buttonLogout);
        add(actions);
    }
}
